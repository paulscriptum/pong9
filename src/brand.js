...
export const BRAND = {
  ...
  promoPhrases: [
    "о, привет",
    "тут не только пинг и понг",
    "8БИТ рассказывает, что сейчас круто",
    "и почему это скоро будет везде",
    "нейросетями уже никого не удивишь",
    "зато у ИИ теперь появляется тело",
    "physical ai — это когда ИИ выходит из экрана",
    "и начинает двигаться в реальном мире",
    "да, роботы снова в моде",
    "только теперь они становятся умнее",
    "а 8БИТ помогает не пропустить самое интересное",
    "удачи в игре!",
    "понг - первая компьютерная игра",
    "и мы ее создали в реальном мире!",
  ],
